...
<body style="background-color: #f4f5f7;">
     ...
     $url_rest_get = "http://20.169.243.49:3000/alertas/";
            ...
            <div class="card mb-3" style="border-radius: .5rem;">
               <div class="row g-0">
                  <div class="col-md-4 gradient-custom text-center text-white"
                     ...
                     <img src="https://cdn2.iconfinder.com/data/icons/navigation-icon/128/attention-512.png" lt="Avatar"
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 for ($i = 0; $i <= $tam_get - 1; $i++) {
                                    $result = $resp_get[$i];
                                    $aa = $result->alerta_arena;
                                    $ar = $result->alerta_residuos;
                                    $es = $result->estado;
                                    $ida = $result->id_arenero;
