...
<body>
    ...
    if (isset($_POST["enviar"])) {
        ...
        $url_rest = "http://20.169.243.49:3000/zona";
        $data = array(
            "descripcion" => $d
        );
        ...
        <div class="container py-4">
            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <div class="card-body p-5 shadow-5 text-center">
                    <h2 class="fw-bold mb-5">Crear zona</h2>
                    <form action="crearzona.php" method="post">
            ...
            height: 650px;">
                <img src="https://media.istockphoto.com/photos/cute-cat-under-sunshine-at-park-picture-id1055113894?k=20&m=1055113894&s=612x612&w=0&h=EUQZmWkm8cJqnXuEJOLKMYMr77NdRIsRjb2Uqsz4Azw=" class="w-100 rounded-4 shadow-4"
                alt="" style="
            height: 95%;"/>
            </div>
            </div>
