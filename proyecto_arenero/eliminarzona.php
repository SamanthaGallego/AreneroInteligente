...
<body>
    ...
    $url_rest_get = "http://20.169.243.49:3000/zona/";
    ...
    if ($_GET) {
        ...
        $url_rest_del = "http://20.169.243.49:3000/zona/$id";
        ...
        header("Location: eliminarzona.php");

    }

    ?>

    <form action="eliminarzona.php" method="post">
                    ...
                    <tbody>
                        <tr>
                            ...
                            for ($i = 0; $i <= $tam_get - 1; $i++) {
                                ...
                                echo "</td>";
                                echo "<td>";
                                echo "<a href=\"?id=" . $id_zona . "\">Borrrar</a>";
                                echo "</td>";
                                echo "</tr>";
