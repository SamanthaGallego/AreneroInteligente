...
<body>
    ...
    if ($_GET) {
        ...
        $url_rest_del = "http://20.169.243.49:3000/datos/$id";
        ...
        header("Location: eliminardatos.php");
                    ...
                    <tbody>
                        <tr>
                            ...
                            for ($i = 0; $i <= $tam_get - 1; $i++) {
                                ...
                                $na = $result->nivelarena;
                                $pa = $result->pesoarenero;
                                $pr = $result->pesoresiduos;
                                ...
                                echo "</td>";
                                echo "<td>";
                                echo "<a href=\"?id=" . $id_datos . "\">Borrrar</a>";
                                echo "</td>";
                                echo "</tr>";
